...
const RegisterPage = () => {
	...
	// 	handleRegister(userName, email, password, setUserName, setEmail, setPassword, setSuccessMessage, setErrorMessage)

	// const messageProps = { successMessage, errorMessage }
	// const btnRegisterProps = { handleRegisterClick, isUserNameValid, isEmailValid, isPasswordValid }
	// const formProps = {
	// 	email,
	// 	password,
	// 	setEmail,
	...
	return (
		<form className={styles.form}>
			<div className='wrapper'>
				{/* <Typography  variant='h1' className={styles.title}>Реєстрація</Typography>
